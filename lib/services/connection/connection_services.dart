...
class ConnectionServices {
  ...
  Future<Map<String, dynamic>> removeConnectionService(String sId) async {
    try {
      var response = await Network.makeDeleteRequestWithToken(
          url: APIConstants.api + '/api/connection?userId=${sId}', body: {});
      return response;
    } catch (e) {
      debugPrint(e.toString());
      return {};
  ...
  Future<Map<String, dynamic>> removeConnectionRequestService(
  ...
  Future<Map<String, dynamic>> acceptConnectionRequest(
      String connectionId) async {
    try {
      var response = await Network.makePutRequestWithToken(
          url: APIConstants.api + '/api/connection',
          body: {'connection_id': connectionId, 'response': "1"});
      return response;
    } catch (e) {
      debugPrint(e.toString());
      return {};
