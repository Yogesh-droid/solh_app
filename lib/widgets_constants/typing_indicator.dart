...
class AnimatedBubbleContatiner extends StatefulWidget {
  ...
  @override
  State<AnimatedBubbleContatiner> createState() => _AnimatedBubbleContatinerState();
}
...
class _BallsRowState extends State<BallsRow> with SingleTickerProviderStateMixin {
  ...
  void initState() {
   ...
   ball1Animation = TweenSequence(
    ...
    ).animate(CurvedAnimation(parent: _controller!, curve: Interval(0,0.4,curve: Curves.bounceIn),));

     ball2Animation = TweenSequence(
      <TweenSequenceItem<double>>[
         TweenSequenceItem<double>(
          tween: Tween<double>(begin: 5, end: 20),
          weight: 1,
    ...
    ).animate(CurvedAnimation(parent: _controller!, curve: Interval(0.2,0.7,curve: Curves.bounceIn)));

     ball3Animation = TweenSequence(
      <TweenSequenceItem<double>>[
         TweenSequenceItem<double>(
          tween: Tween<double>(begin: 5, end: 20),
          weight: 1,
    ...
    ).animate(CurvedAnimation(parent: _controller!, curve: Interval(0.5,1,curve: Curves.bounceIn)));
