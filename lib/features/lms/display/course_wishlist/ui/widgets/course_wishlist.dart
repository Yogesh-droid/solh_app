              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) => CourseWishlistCard(
                  ...
                  courseTitle: courseWishlistController
                      ...
                      '',
                  courseDurationHours: courseWishlistController.courseWishlist
                          .value.courses![index].totalDuration!.hours ??
                      0,
                  courseDurationMinutes: courseWishlistController.courseWishlist
                          .value.courses![index].totalDuration!.minutes ??
                      0,
                  currency: courseWishlistController
                          .courseWishlist.value.courses![index].currency ??
                      '',
                  instructorName: courseWishlistController.courseWishlist.value
                  ...
                  rating: courseWishlistController
                      ...
                      0.0,
                  salePrice: courseWishlistController
                          .courseWishlist.value.courses![index].salePrice ??
                      0,
                ),
              ),
            );
